...
abstract class ActiveRecordEntity implements \JsonSerializable
{
    ...
    private function underscoreToCamelCase(string $source): string   /* метод для приведения наименований столбцов БД к свойствам класса*/
    {
...
//    private function insert(array $mappedProperties): void     //Второй вариант добавления записи в БД.
//    {
//        $params2values = [];
//        $index = 1;
//
...
//    }
    ...
    public static function getPagesCount(int $itemsPerPage): int //  //реализация пагинации. метод для получения количества страниц
    {
        $db = Db::getInstance();
     ...
     * @return static[]
     */
    public static function getPage(int $pageNum, int $itemsPerPage): array //метод для получения записей на n-ой страничке.
    {
        $db = Db::getInstance();
        return $db->query(
            sprintf(
